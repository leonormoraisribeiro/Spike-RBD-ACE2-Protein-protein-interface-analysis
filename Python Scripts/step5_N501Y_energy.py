...
# Mutant files (N501Y)
# ----------------------------
MUT_PDBQT = "mut_N501Y_complex.pdbqt"
MUT_ASA_COMPLEX = "mut_N501Y_complex.asa"
MUT_ASA_A = "mut_N501Y_A.asa"
MUT_ASA_B = "mut_N501Y_B.asa"
...
print(f"N501Y ΔG = {G_mut:.3f} kcal/mol")

ddG = G_mut - G_wt

print("\n==============================")
print(f"ΔΔG (N501Y) = {ddG:.3f} kcal/mol")
print("==============================")
